...
const CREDITS: Array[Array] = [
	...
	["", 20],
	["Sphinx statue", 22],
	["\"Crystal Palace Sphinx\" by artfletch (CC-BY 4.0)", 24],
	["", 20],
	["Anubis jackal", 22],
	["\"Statuette of a Jackal\" by Art Institute of Chicago (CC-BY 4.0)", 24],
	["", 20],
	["Bastet cat", 22],
	["\"Egyptian Cat Statue\" by Ankledot (CC-BY 4.0)", 24],
	["", 20],
	["Scarab", 22],
